...
<?php foreach( $cta as $a ) : ?>
  <?php if ( isset($a['phila_post_links']['link_text'] ) ) : ?>
    <div class="mbm">
      <div class="h4"><a href="<?php echo $a['phila_post_links']['link_url']?>" class="<?php echo isset($a['phila_post_links']['is_external'] ) ? 'external ': '';?>"><i class="fal fa-arrow-right"></i> <?php echo $a['phila_post_links']['link_text']?></a></div>
